    ...
    "1B+e": function(t, e, n) {
        ...
        var x = function(t) {
            ...
            function n(t, a) {
                ...
                ,
                i._eventPointerDown = function(t) {
                    i._startDraw(t)
                }
                ,
                i._eventPointerMove = function(t) {
                    i._coordenada(t)
                }
                ,
                i._eventPointerUp = function(t) {
                    i._endDraw(t);
                }
                ,
                i._eventElem.addEventListener("pointerdown", i._eventPointerDown, !1),
                document.addEventListener("pointermove", i._eventPointerMove, !1),
                document.addEventListener("pointerup", i._eventPointerUp, !1))),
            ...
            return Object(c.a)(n, [{
                ...
                value: function(t, e) {
                    ...
                    n = 1; n < t.length; n++)
                    this._local[e].quadraticCurveTo(t[n - 1][0] * this._opcoes.retina,
                ...
                value: (function() {
                    ...
                    if (this._liberado) {
                        ...
                        if (this._draw && this._liberado) {
                            if (this._tipo == 0) {
                                this._codigoQuebra && this._stack.length > this._opcoes.quebra &&
                                ...
                                this._xFirst = this._xCoord,
                                this._yFirst = this._yCoord;
                            } else if (this._tipo == 9) {
                                let currentPressure = t.pressure;
                                let thickness = null;
                                if (lastPressure === null || Math.abs(currentPressure - lastPressure) > PRESSURE_THRESHOLD) {
                                    lastPressure = currentPressure;  // Update last used pressure value
                                    thickness = this._borda * lastPressure;
                                    O(Object(f.a)(n.prototype), "emit", this).call(this, "codigo", [6, thickness.toString()]);
                                    this.salvarEstado(!1);
                                } else {
                                    thickness = this._borda * lastPressure;
                                }

                                this._local[0].beginPath();
                                this._local[0].lineWidth = thickness * this._opcoes.retina;
                                this._local[0].moveTo(this._xFirst * this._opcoes.retina, this._yFirst * this._opcoes.retina),
                                this._local[0].lineTo(this._xCoord * this._opcoes.retina, this._yCoord * this._opcoes.retina),
                                this._local[0].stroke();
                                this._local[0].closePath();
                                O(Object(f.a)(n.prototype), "emit", this).call(this, "codigo", [2, this._xFirst, this._yFirst, this._xCoord, this._yCoord]);
                                this._xFirst = this._xCoord;
                                this._yFirst = this._yCoord;
                            } else if (1 == this._tipo) {
                                (this._stack.length > this._opcoes.quebra && (this._des_cod.push(this._stack),
                                O(Object(f.a)(n.prototype), "emit", this).call(this, "codigo", this._stack),
                ...
                key: "mudaOpcao",
                value: function(t) {
                    if (this._tipo == 9) this.mudaBorda(this._bordaTemp, !0);
                ...
                value: function() {
                    ...
                    this._eventPointerDown && (this._eventElem.removeEventListener("pointerdown", this._eventPointerDown, !1),
                    document.removeEventListener("pointermove", this._eventPointerMove, !1),
                    document.removeEventListener("pointerup", this._eventPointerUp, !1))
                }
            }, {
                key: "sequencia",
                get: function() {
        ...
        var ct = function(t) {
            ...
            return Object(c.a)(n, [{
                ...
                value: function() {
                    ...
                    }, [0, 9, 1, 2, 3, 4, 5, 6, 7, 8].map((function(t) {
                        return st("li", {
                            id: "op" + t,
                            className: z()("tool", {
                                active: t == i
        ...
        var $t = function(t) {
            ...
            return Object(c.a)(n, [{
                ...
                value: function() {
                    ...
                    style.innerHTML = `#screenRoom .ctt .users-tools #tools ul li#op9:before { content: "\\E96B"; }`;
